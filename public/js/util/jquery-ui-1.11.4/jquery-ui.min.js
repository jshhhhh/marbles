...
* http://jqueryui.com
* Includes: core.js,
 * widget.js, mouse.js, position.js, draggable.js, droppable.js, sortable.js
*
...
(function (e) {
            ...
            drag: function (t, i, s) {
                ...
                for (c = s.snapElements.length - 1; c >= 0; c--) 
                    ...
                    d = u + s
                        .snapElements[c]
                        .height,
                    h - m > v || g > l + m || u - m > b || _ > d + m || !e.contains(
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _getParentOffset: function () {
            ...
            (
                this.offsetParent[0] === this.document[0].body || this.offsetParent[0].tagName && "html" === this.offsetParent[0].tagName.toLowerCase() && e.ui.ie
            ) && (t = {
                top: 0,
                left: 0
            }), {
        ...
        _convertPositionTo: function (t, i) {
            ...
            var s = "absolute" === t
                    ? 1
                    : -1,
                n = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && e.contains(
                    this.scrollParent[0],
                    this.offsetParent[0]
                )
                    ? this.scrollParent
        ...
        _generatePosition: function (t) {
            var i,
                ...
                a = t.pageX,
                o = t.pageY,
                r = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && e.contains(
                    this.scrollParent[0],
                    this.offsetParent[0]
                )
                    ? this.scrollParent
            ...
            return "relative" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && this.scrollParent[0] !== this.offsetParent[0] || (
